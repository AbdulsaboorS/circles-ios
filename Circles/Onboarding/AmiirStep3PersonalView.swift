...
struct AmiirStep3PersonalView: View {
    ...
    private var canSelectMore: Bool { coordinator.selectedPersonalHabits.count < 3 }
            ...
            VStack(spacing: 0) {
                ScrollView {
                    VStack(spacing: 28) {
                        ...
                        if coordinator.selectedPersonalHabits.count == 3 {
                            Text("Maximum 3 intentions selected.")
                                .font(.appCaption)
                                .foregroundStyle(Color.msGold)
                        }
